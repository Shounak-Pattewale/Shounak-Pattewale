...
developer = {
    ...
    "stack":      ["Python", "Flask", "FastAPI", "MongoDB", "Docker", "PostgreSQL", "Redis"],
    "currently":  ["ScanTrack — warehouse + 1C ERP", "Pinta Platform — B2B catalog", "shounakdev.tech"],
    "visa":       "Post Study Work → seeking Skilled Worker sponsorship",
    "status":     "open_to_work",
}
```
